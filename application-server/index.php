...
if (empty($LIVEKIT_API_KEY) || empty($LIVEKIT_API_SECRET) || $LIVEKIT_API_KEY === "" || $LIVEKIT_API_SECRET === "") {
    http_response_code(500);
    echo json_encode([
        "errorMessage" => "LiveKit API credentials not configured. Please set LIVEKIT_API_KEY and LIVEKIT_API_SECRET in your .env file with valid LiveKit Cloud credentials."
    ]);
    exit();
}
